...
public class SinaBlogProcessor implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        if (page.getUrl().regex(URL_LIST).match()) {
            ...
            page.putField("content", page.getHtml().xpath("//div[@id='articlebody']//div[@class='articalContent']/text()"));
    ...
    public static void main(String[] args) {
        Spider.create(new SinaBlogProcessor()).addPipeline(new ConsolePipeline()).addPipeline(new FilePipeline()).addUrl("http://blog.sina.com.cn/s/articlelist_1487828712_0_1.html")
                .run();
    }
}